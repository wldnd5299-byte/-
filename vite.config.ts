    ...
    build: {
      rollupOptions: {
        input: {
          ...
          surgery_1to3: path.resolve(__dirname, 'surgery/1to3/index.html'),
          surgery_1to3_type1: path.resolve(__dirname, 'surgery/1to3/type-1/index.html'),
          surgery_1to3_type2: path.resolve(__dirname, 'surgery/1to3/type-2/index.html'),
          surgery_1to3_type3: path.resolve(__dirname, 'surgery/1to3/type-3/index.html'),
          surgery_1to7: path.resolve(__dirname, 'surgery/1to7/index.html'),
          surgery_1to7_type1: path.resolve(__dirname, 'surgery/1to7/type-1/index.html'),
          surgery_1to7_type2: path.resolve(__dirname, 'surgery/1to7/type-2/index.html'),
          surgery_1to7_type3: path.resolve(__dirname, 'surgery/1to7/type-3/index.html'),
          surgery_1to7_type4: path.resolve(__dirname, 'surgery/1to7/type-4/index.html'),
          surgery_1to7_type5: path.resolve(__dirname, 'surgery/1to7/type-5/index.html'),
          surgery_1to7_type6: path.resolve(__dirname, 'surgery/1to7/type-6/index.html'),
          surgery_1to7_type7: path.resolve(__dirname, 'surgery/1to7/type-7/index.html'),
          surgery_1to8: path.resolve(__dirname, 'surgery/1to8/index.html'),
          surgery_1to8_type1: path.resolve(__dirname, 'surgery/1to8/type-1/index.html'),
          surgery_1to8_type2: path.resolve(__dirname, 'surgery/1to8/type-2/index.html'),
          surgery_1to8_type3: path.resolve(__dirname, 'surgery/1to8/type-3/index.html'),
          surgery_1to8_type4: path.resolve(__dirname, 'surgery/1to8/type-4/index.html'),
          surgery_1to8_type5: path.resolve(__dirname, 'surgery/1to8/type-5/index.html'),
          surgery_1to8_type6: path.resolve(__dirname, 'surgery/1to8/type-6/index.html'),
          surgery_1to8_type7: path.resolve(__dirname, 'surgery/1to8/type-7/index.html'),
