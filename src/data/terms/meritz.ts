...
// ==========================================
// 메리츠화재 80대질병수술 (SOURCE-LOCK: meritz-disease-surgery-80.pdf)
// ==========================================

// 메리츠화재 80대질병수술 상단 요약 분류표 데이터
export const MERITZ_80_DISEASES_SUMMARY_SECTIONS = [
  {
    "title": "심장질환",
    "items": [
      {
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "4",
        "disease": "만성 하부 호흡기 질환",
        "code": ""
      },
      {
        "num": "5",
        "disease": "위궤양 및 십이지장궤양",
        "code": ""
      },
      {
        "num": "6",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "10",
        "disease": "뇌 및 중추신경계통의 양성신생물",
        "code": ""
      },
      {
        "num": "11",
        "disease": "갑상선 및 내분비선의 양성신생물",
        "code": ""
      },
      {
        "num": "12",
...
// 메리츠화재 80대질병 분류표 세부 데이터 (총 80개 카테고리)
export const MERITZ_80_DISEASES_SECTIONS = [
  {
    "division": "심장질환",
    "category": "심장질환",
    "group": "심장질환",
    ...
    "items": [
      ...
      {
        "num": "6",
        "disease": "수막알균성 심근염(I41.0*)",
        "code": "A39.5†"
      },
      {
        "num": "7",
        "disease": "수막알균성 심내막염(I39.8*)",
        "code": "A39.5†"
      },
      {
        "num": "8",
        "disease": "수막알균성 심장막염(I32.0*)",
        "code": "A39.5†"
      },
      {
        "num": "9",
        "disease": "수막알균성 심장염 NOS(I52.0*)",
        "code": "A39.5†"
      },
      {
        "num": "10",
        "disease": "칸디다심내막염(I39.8*)",
        "code": "B37.6†"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "num": "5",
        "disease": "출혈 또는 경색증으로 명시되지 않는 뇌졸중",
        "code": "I64"
      },
      {
        "num": "6",
        "disease": "뇌경색증을 유발하지 않은 뇌전동맥의 폐쇄 및 협착",
        "code": "I65"
      },
      {
        "num": "7",
        "disease": "뇌경색증을 유발하지 않은 대뇌동맥의 폐쇄 및 협착",
        "code": "I66"
      },
      {
        "num": "8",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "3",
        "disease": "거대세포바이러스간염(K77.0*)",
        "code": "B25.1†"
      },
      {
        "num": "4",
        "disease": "톡소포자충간염(K77.0*)",
        "code": "B58.1†"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "num": "6",
        "disease": "고혈압성 망막병증 (단, 고혈압성 망막병증 이외의 배경망막병증 및 망막혈관변화는 제외)",
        "code": "H35.0"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "3",
        "disease": "결핵성 복막염(A18.30†)",
        "code": "K67.3*"
      },
      {
        "num": "4",
        "disease": "장, 복막 및 장간막림프절의 결핵성 장애(A18.3-*)",
        "code": "K93.0*"
      },
      {
        "num": "5",
        "disease": "결핵관절염(A18.01+)",
        "code": "M01.1*"
      },
      {
        "num": "6",
        "disease": "척추의 결핵(A18.00+)",
        "code": "M49.0*"
      },
      {
        "num": "7",
        "disease": "뼈의 결핵(A18.02+)",
        "code": "M90.0*"
      },
      {
        "num": "8",
        "disease": "결핵성 방광염(A18.11+)",
        "code": "N33.0*"
      },
      {
        "num": "9",
        "disease": "자궁경부의 결핵감염(A18.17+)",
        "code": "N74.0*"
      },
      {
        "num": "10",
        "disease": "여성 결핵성 골반염증질환(A18.17+)",
        "code": "N74.1*"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "2",
        "disease": "달리 분류된 세균성 질환에서의 수막염(수막알균수막염 G01*)",
        "code": "G01 / A39.0†"
      },
      {
        "num": "3",
        "disease": "달리 분류된 기타 감염성 및 기생충 질환에서의 수막염 (아데노바이러스수막염 G02.0*, 엔테로바이러스수막염 G02.0*, 헤르페스바이러스수막염 G02.0*, 수두수막염 G02.0*, 대상포진수막염 G02.0*, 수막염이 합병된 홍역 G02.0*, 볼거리수막염 G02.0*, 칸디다수막염 G02.1*, 콕시디오이데스진균수막염 G02.1*)",
        "code": "G02"
      },
      {
        "num": "4",
      ...
      {
        "num": "6",
        "disease": "달리 분류된 질환에서의 뇌염, 척수염 및 뇌척수염 (아데노바이러스뇌염 G05.1*, 엔테로바이러스뇌염 G05.1*, 헤르페스바이러스뇌염 G05.1*, 수두뇌염 G05.1*, 대상포진뇌염 G05.1*, 뇌염이 합병된 홍역 G05.1*, 볼거리뇌염 G05.1*)",
        "code": "G05"
      },
      {
        "num": "7",
      ...
      {
        "num": "8",
        "disease": "달리 분류된 질환에서의 두개내 및 척추내 농양 및 육아종(아메바성 뇌농양 G07*)",
        "code": "G07 / A06.6†"
      },
      {
        "num": "9",
        "disease": "두개내 및 척추내 정맥염 및 혈전정맥염",
        "code": "G08"
      },
      {
        "num": "10",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "10",
        "disease": "폐렴이 합병된 홍역(J17.1*)",
        "code": "B05.2†"
      },
      {
        "num": "11",
        "disease": "거대세포바이러스폐렴(J17.1*)",
        "code": "B25.0†"
      },
      {
        "num": "12",
        "disease": "폐톡소포자충증(J17.3*)",
        "code": "B58.3†"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "2",
        "disease": "달리 분류된 질환에서의 담낭, 담도 및 췌장의 장애 (거대세포바이러스췌장염 K87.1*, 볼거리췌장염 K87.1*)",
  ...
  },
  {
    ...
    "category": "소화계통의 양성신생물",
    "group": "다빈도48대질병",
    "title": "[다빈도48대질병] 소화계통의 양성신생물",
    "items": [
      {
        "num": "1",
        "disease": "기타 및 부위불명 소화계통의 양성 신생물",
        "code": "D13"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "num": "2",
        "disease": "기타 및 상세불명의 흉곽내 기관의 양성 신생물",
        "code": "D15"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "중피조직의 양성 신생물",
        "code": "D19"
      },
      {
        "num": "2",
        "disease": "후복막 및 복막 연조직의 양성 신생물",
        "code": "D20"
      },
      {
        "num": "3",
        "disease": "결합조직 및 기타 연조직의 기타 양성 신생물",
        "code": "D21"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "뇌 및 중추신경계통의 기타 부분의 양성 신생물",
        "code": "D33"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "num": "2",
        "disease": "기타 및 상세불명의 내분비선의 양성 신생물",
        "code": "D35"
      }
    ]
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "갑상선의 장애 (갑상선이상성 안구돌출 E05.0*)",
        "code": "E00 ~ E07 / H06.2*"
      },
      {
        "num": "2",
        "disease": "처치후 갑상선기능저하증, 방사선조사후 갑상선기능저하증, 수술후 갑상선기능저하증",
        "code": "E89.0"
      }
    ]
  },
  {
    ...
    "items": [
      ...
      {
        "num": "2",
        "disease": "부갑상선기능항진증 및 부갑상선의 기타 장애",
        "code": "E21"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "중이 및 유돌의 질환 (중이염이 합병된 홍역 H67.1*, 홍역후 중이염 H67.1*)",
        "code": "H65 ~ H75 / B05.3†"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "공막, 각막, 홍채 및 섬모체의 장애 (홍채섬모체염 H22.0*, 홍채염 H22.0*, 전방포도막염 H22.0*, 각막염 H19.1*, 각막결막염 H19.1*, 각막상피염 H19.1*, 간질각막염 H19.1*, 각막내피염 H19.1*, 아데노바이러스에 의한 각막결막염 H19.2*, 유행성 각막결막염 H19.2*, 조선소눈병 H19.2*)",
        "code": "H15 ~ H22 / B00.50+, B00.51+, B30.0+"
      },
      {
        "num": "2",
        "disease": "맥락막 및 망막의 장애 (단, 고혈압성 망막병증 H35.0, 황반변성 H35.3, 당뇨병 망막병증 H36.0 제외)",
        "code": "H30 ~ H36"
      },
      {
        "num": "3",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "9",
        "disease": "달리 분류된 질환에서의 사구체장애 (당뇨병에서의 사구체장애 N08.3 제외)",
        "code": "N08"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "5",
        "disease": "달리 분류된 질환에서의 요도장애 (칸디다 방광염 및 요도염 N37.0*)",
        "code": "N37 / B37.40†"
      },
      {
        "num": "6",
        "disease": "비뇨계통의 기타 장애 (결핵성 방광염 A18.11†, 스트레스요실금 N39.3, 기타 명시된 요실금 N39.4 제외)",
        "code": "N39"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "4",
        "disease": "달리 분류된 질환에서의 식도의 장애 (결핵성 식도염 A18.82†, K23.0 제외)",
        "code": "K23"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "복막의 질환 (결핵성 복막염 A18.30†, K67.3 제외)",
        "code": "K65 ~ K67"
      }
    ]
  },
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "num": "4",
        "disease": "달리 분류된 질환에서의 단일신경병증 (당뇨병성 단일신경병증 G59.0 제외)",
        "code": "G59"
      }
    ]
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "감염성 관절병증 (결핵 관절염 A18.01†, M01.1 제외)",
        "code": "M00 ~ M03"
      },
      {
        "num": "2",
        "disease": "염증성 다발관절병증 (당뇨병성 관절병증 M14.2 제외, 류마티스페질환 M05.1†)",
        "code": "M05 ~ M14 / J99.0*"
      },
      {
        "num": "3",
  ...
  },
  {
    ...
    "items": [
      {
        "num": "1",
        "disease": "남성 생식기관의 질환 (남성 불임 제외, 편모충성 전립선염 N51.0*, 볼거리고환염 N51.1*)",
        "code": "N40~N45, N47~N51 / A59.08†, B26.0†"
      },
      {
        "num": "2",
        "disease": "여성 골반내 기관의 염증성 질환 (자궁경부 결핵감염 A18.17† N74.0, 여성 결핵성 골반염증질환 A18.17† N74.1 제외)",
        "code": "N70 ~ N77"
      },
      {
        "num": "3",
        "disease": "여성 생식관의 비염증성 장애 (습관성 유산자, 여성 불임, 인공 수정 관련 합병증 제외)",
        "code": "N80 ~ N95"
      },
      {
        "num": "4",
